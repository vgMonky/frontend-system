    ...
    <div class="landing-page">
      ...
      <main class="content">
        <section id="philosophy">
          <h2>1. Design Philosophy: Constraint-Driven Development</h2>
        ...
        <section id="architecture">
          <h2>2. System Architecture: Structured for Rapid Content Production</h2>
