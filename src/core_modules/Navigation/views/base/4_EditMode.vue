...
import { toggleEditMode, getEditMode } from '@/core_modules/Navigation/toggleEditMode';

const editMode = computed({
  get: () => getEditMode().value,
  set: () => toggleEditMode()
});

const toggleIcon = computed(() => editMode.value ? Pencil : MonitorCheck);
</script>
